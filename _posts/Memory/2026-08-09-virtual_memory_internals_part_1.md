...
[63:48] 1111111111111111 ──▶ Selects TTBR1_EL1 (Kernel Space)
                                 ...
                                 ▼
                        ┌──────────────────┐
[47:39] 110101110 ─────▶│    PGD Table     │ 
        (Index 430)     ├──────────────────┤
                        │ entry 0          │
                        │ ...              │
                        │ entry 430        ├──────┐  (Descriptor holds PUD Base)
                        │ ...              │      │
                        │ entry 511        │      │
                        └──────────────────┘      │
                                                  ▼
                                         ┌──────────────────┐
[38:30] 011000111 ──────────────────────▶│    PUD Table     │ 
        (Index 199)                      ├──────────────────┤
                                         │ entry 0          │
                                         │ ...              │
                                         │ entry 199        ├──────┐  (Descriptor holds PMD Base)
                                         │ ...              │      │
                                         │ entry 511        │      │
                                         └──────────────────┘      │
                                                                   ▼
                                                          ┌──────────────────┐
[29:21] 011110101 ───────────────────────────────────────▶│    PMD Table     │ 
        (Index 245)                                       ├──────────────────┤
                                                          │ entry 0          │
                                                          │ ...              │
                                                          │ entry 245        ├──────┐  (Descriptor holds PTE Base)
                                                          │ ...              │      │
                                                          │ entry 511        │      │
                                                          └──────────────────┘      │
                                                                                    ▼
                                                                           ┌──────────────────┐
[20:12] 011011011 ────────────────────────────────────────────────────────▶│    PTE Table     │ 
        (Index 219)                                                        ├──────────────────┤
                                                                           │ entry 0          │
                                                                           │ ...              │
                                                                           │ entry 219        ├──────┐  (Page Descriptor)
                                                                           │ ...              │      │
                                                                           │ entry 511        │      │
                                                                           └──────────────────┘      │
                                                                                                     ▼
                                                                                          Physical Page Base
                                                                                                   +
[11:0]  111011101111 ───────────────────────────────────────────────────────────────────▶ Offset 3823 (0xEEF)
 i = VA[47:39]          j = VA[38:30]         k = VA[29:21]         l = VA[20:12]   offset = VA[11:0]
